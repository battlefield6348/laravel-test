...
class CurrencyExchangeController extends Controller
{
    public function exchange(FormRequest $request) {
        ...
        if ($validator->fails()) {
            ...
            return response()->json($errorContent, Response::HTTP_BAD_REQUEST, [], JSON_UNESCAPED_UNICODE);
        }
        ...
        try {
            ...
            return response()->json($errorContent, Response::HTTP_INTERNAL_SERVER_ERROR, [], JSON_UNESCAPED_UNICODE);
        }
        return response()->json(['msg' => 'success', 'amount' => $result], Response::HTTP_OK, [], JSON_UNESCAPED_UNICODE);
    }
}
